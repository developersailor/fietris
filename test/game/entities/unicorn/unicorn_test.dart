...
import 'package:fietris/game/entities/unicorn/behaviors/behaviors.dart';
import 'package:fietris/game/game.dart';
...
class _Fietris extends Fietris {
  _Fietris({
    required super.l10n,
